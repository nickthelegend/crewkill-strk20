...
const OBSIDIAN: ShipMap = {
  ...
  rooms: [
    {
      id: 0, name: "Cafeteria", x: 1900, y: 120, width: 900, height: 620,
    ...
    {
      id: 1, name: "Admin", x: 2050, y: 900, width: 560, height: 460,
    ...
    {
      id: 2, name: "Storage", x: 1900, y: 1560, width: 900, height: 620,
    ...
    {
      id: 3, name: "Electrical", x: 900, y: 2400, width: 620, height: 520,
    ...
    {
      id: 4, name: "MedBay", x: 950, y: 120, width: 620, height: 520,
    ...
    {
      id: 5, name: "Upper Engine", x: 180, y: 120, width: 600, height: 520,
    ...
    {
      id: 6, name: "Lower Engine", x: 180, y: 2400, width: 600, height: 520,
      wall: "#5a3a3a", floor: "#6a4a4a", pattern: "grate", hasTasks: true,
      fixtures: [
        { kind: "engine", x: 120, y: 110, w: 340, h: 280 },
    ...
    {
      id: 7, name: "Security", x: 180, y: 1300, width: 560, height: 460,
    ...
    {
      id: 8, name: "Reactor", x: 180, y: 750, width: 560, height: 460,
    ...
    {
      id: 9, name: "Weapons", x: 3000, y: 120, width: 620, height: 520,
    ...
    {
      id: 10, name: "Navigation", x: 3800, y: 800, width: 620, height: 520,
    ...
    {
      id: 11, name: "Shields", x: 3000, y: 1560, width: 620, height: 520,
    ...
    {
      id: 12, name: "O2", x: 3900, y: 1560, width: 520, height: 440,
    ...
    {
      id: 13, name: "Communications", x: 1900, y: 2500, width: 620, height: 460,
...
const KUIPER: ShipMap = {
  ...
  rooms: [
    {
      id: 0, name: "Hub", x: 1650, y: 1450, width: 900, height: 700,
    ...
    {
      id: 1, name: "North Dock", x: 1750, y: 250, width: 700, height: 520,
    ...
    {
      id: 2, name: "Cryo Bay", x: 2900, y: 600, width: 640, height: 520,
    ...
    {
      id: 3, name: "East Array", x: 3300, y: 1500, width: 640, height: 560,
    ...
    {
      id: 4, name: "Fuel Cells", x: 2900, y: 2450, width: 640, height: 540,
    ...
    {
      id: 5, name: "South Dock", x: 1750, y: 2850, width: 700, height: 500,
      wall: "#3a5a6a", floor: "#48697a", pattern: "plate", hasTasks: true,
      fixtures: [
    ...
    {
      id: 6, name: "Watch Post", x: 620, y: 2450, width: 620, height: 540,
    ...
    {
      id: 7, name: "West Array", x: 260, y: 1500, width: 640, height: 560,
      wall: "#4a4a72", floor: "#5a5a86", pattern: "plate", hasTasks: true,
      fixtures: [
    ...
    {
      id: 8, name: "Reactor Ring", x: 620, y: 600, width: 640, height: 540,
...
const DEEPCORE: ShipMap = {
  ...
  rooms: [
    {
      id: 0, name: "Surface Dock", x: 1100, y: 180, width: 900, height: 560,
    ...
    {
      id: 1, name: "Upper Lift", x: 300, y: 900, width: 460, height: 420,
    ...
    {
      id: 2, name: "Assay Lab", x: 1150, y: 950, width: 700, height: 520,
    ...
    {
      id: 3, name: "Ore Sorting", x: 2200, y: 950, width: 780, height: 560,
    ...
    {
      id: 4, name: "Shaft Watch", x: 300, y: 1700, width: 520, height: 460,
      wall: "#3a4a6a", floor: "#455680", pattern: "plate", hasTasks: false,
      fixtures: [
    ...
    {
      id: 5, name: "Drill Head", x: 1150, y: 1900, width: 820, height: 620,
    ...
    {
      id: 6, name: "Coolant", x: 2300, y: 1900, width: 680, height: 560,
    ...
    {
      id: 7, name: "Lower Lift", x: 300, y: 2700, width: 460, height: 420,
      wall: "#3f4a5a", floor: "#4d5b6e", pattern: "plate", hasTasks: false,
      fixtures: [
        { kind: "console", x: 130, y: 120, w: 200, h: 120 },
        { kind: "vent", x: 380, y: 330 },
    ...
    {
      id: 8, name: "Core Reactor", x: 1150, y: 2950, width: 820, height: 620,
      wall: "#6a3438", floor: "#7d4247", pattern: "hazard", hasTasks: true,
      fixtures: [
    ...
    {
      id: 9, name: "Deep Store", x: 2300, y: 2950, width: 680, height: 560,
